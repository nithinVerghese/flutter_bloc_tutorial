...
import 'package:flutter_bloc_tutorial/wrapper.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _decrementCounter() {
    BlocProvider.of<IncrementBloc>(context).add(DecrementEvent());
  }

  void _resetCounter() {
    BlocProvider.of<IncrementBloc>(context).add(ResetEvent());
  }
